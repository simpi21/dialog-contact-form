 ...
 */
if ( ! class_exists( 'Dialog_Contact_Form_Settings_API' ) ) {
	/**
	 * Class Dialog_Contact_Form_Settings_API
	 */
	class Dialog_Contact_Form_Settings_API {
		/**
		...
		/**
		 * @return Dialog_Contact_Form_Settings_API
		 */
		 ...
		 *
		 * @return WP_Error|Dialog_Contact_Form_Settings_API
		 */
