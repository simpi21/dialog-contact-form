...
class DataExportRequest extends Action {
	...
	public function __construct() {
		...
		$this->meta_group = 'data_export_request';
		$this->meta_key   = '_action_data_export_request';
	...
	public static function process( $config, $data ) {
		$settings   = get_post_meta( $config->getFormId(), '_action_data_export_request', true );
	...
	public function get_description() {
		...
		$html .= esc_html__( 'This action adds users to WordPress\' personal data export tool, allowing admins to comply with the GDPR and other privacy regulations from the site\'s front end.', 'dialog-contact-form' );
		$html .= '</p>';
