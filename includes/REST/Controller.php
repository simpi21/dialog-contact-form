...
class Controller {
    ...
    public function respondWithError( $data = null, $message = null ) {
        ...
        $response = array( 'success' => false, 'message' => $message, 'code' => $code );
    ...
    public function respondWithSuccess( $data = null, $message = null ) {
        ...
        $response = array( 'success' => true, 'message' => $message, 'code' => $code );
     ...
     */
    protected static function formatDate( $date, $type = 'iso' ) {
        ...
        if ( ! in_array( $type, array( 'raw', 'mysql', 'timestamp', 'view', 'iso' ) ) ) {
